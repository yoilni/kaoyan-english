...
function updateLatestHomepage(){if(!document.getElementById('progressDashboard'))return;const hero=document.querySelector('.hero-card a.primary');if(hero){hero.href='days/2026-09-18.html';hero.textContent='继续今天：09-18 · 体育 × 创作者经济 × 媒体边界'}const links=document.querySelector('.day-links');if(links&&!links.querySelector('a[href="days/2026-09-18.html"]')){const a=document.createElement('a');a.className='btn';a.href='days/2026-09-18.html';a.textContent='09-18 · 体育 × 创作者经济 × 媒体边界';links.prepend(a)}const list=document.querySelector('.history-list');if(list&&!list.querySelector('a[href="days/2026-09-18.html"]')){const li=document.createElement('li');li.innerHTML='<a href="days/2026-09-18.html"><b>2026-09-18</b> · 体育 × 创作者经济 × 媒体边界</a><br>When Athletes Become Creators: Attention, Income and Boundaries';list.prepend(li)}}
